...
def compute_advantage(data: DataProto, adv_estimator, gamma=1.0, lam=1.0, num_repeat=1, multi_turn=False, norm_adv_by_std_in_grpo=True):
    ...
    if adv_estimator == AdvantageEstimator.GAE:
        ...
        # print token_level_rewards for 100 samples
        for i in range(100):
            rewards_i = data.batch['token_level_rewards'][i]
            mask_i = data.batch['loss_mask'][i].bool()  # explicite: booléen

            print(f"[{i}] token_level_rewards.shape: {rewards_i.shape}")
                ...
                with _timer("step", timing_raw):
                    ...
                    with _timer("adv", timing_raw):
                        ...
                        if balance_advantage:
                            ...
                            assert 0.0 < tr < 1.0, "positive_advantage_ratio must be 0 < ratio < 1"
